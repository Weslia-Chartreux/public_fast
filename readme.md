Этот проект является частью проекта для работы с адресами и служит хранилищем адресов, которые пользователи уже использовали в сервисе, чтобы не вызывать все время api сторонних ресурсов.
